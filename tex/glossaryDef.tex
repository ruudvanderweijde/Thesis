...
\begin{document}
    ...
    \newglossaryentry{PSR}
    {
        name=PSR,
        description={
            PHP Standard Recommandation (PSR) is project which provides rules for commonalities between PHP projects.
            Autoloading, coding styleguide, logging, and HTTP Message interface are the first few accepted standards.
