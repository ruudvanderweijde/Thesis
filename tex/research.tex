...
\begin{document}
    ...
    Because language constructs are different and are therefor not applicable for PHP and the other way around.
    For the overlapping constructs we created a similar structure.
    The model will be used to query the system for information. % vaag..
