...
% https://en.wikibooks.org/wiki/LaTeX/Linguistics
   ...
   \end{table}
    ...
    \fact{arrayAccess}{Array access}{
    	...
    	For all other cases, when the base type is not an string or array, the result of the expression will be of \texttt{null} type.
    }
    ...
    %%
    \subsection{Class}
    This section contains fact extraction rules from object related syntax.
    Special keywords, class instantiation, method calls, parameters, and class constants.
