...
\CAT{Keyword}{anno} \CAT{Keyword}{rel}{}[\CAT{Keyword}{loc} definition, \CAT{Keyword}{loc} comments] M3@documentation; \CAT{Comment}{// comments and doc-blocks}\end{rascal}%%%%%%%%%%%%%%%%%%{ RASCAL }%%%%%%%%%%%%%%%%%%
    ...
    \paragraph{Documentation} \texttt{Documentation} contains all the comments and doc-blocks of the source code.
    This information is mapped to a declaration.
...
\CAT{Keyword}{anno} \CAT{Keyword}{rel}{}[\CAT{Keyword}{loc} from, \CAT{Keyword}{loc} to] M3@traitUses;    \CAT{Comment}{// classes using traits and traits using traits}
...
\CAT{Keyword}{anno} \CAT{Keyword}{rel}{}[\CAT{Keyword}{loc} pos, Annotation annotation] M3@annotations;    \CAT{Comment}{// result of parsed php docs}
	...
	\paragraph{Extends} \texttt{Extends} contains information about what classes and interface extend other classes of interfaces.
    ...
    \paragraph{Implements} \texttt{Implements} holds information on what class implements which interfaces.
    ...
    \paragraph{TraitUses} \texttt{TraitUses} knows which traits a class uses.
    ...
    \paragraph{Constructors} \texttt{Constructors} lists all the constructors for classes. 
