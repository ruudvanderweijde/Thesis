...
\begin{document}
    ...
    Chapter \ref{chap:background} describes seven important language constructs in section \ref{sec:background_language-constructs} which you need to understand in order to understand the difficulties of analysing PHP.
    The second section, \ref{sec:background_annotations}, gives an introduction to the syntax and usage of annotation in PHP.
    Section \ref{sec:background_rascal} explains the used programming language \Gls{Rascal}.
    $M^3$ is a generic model designed to analyse programming languages and is described in more details in section \ref{sec:background_m3}.
    The final section, section \ref{sec:background_related-work} of this chapter describes the related work and how these researches are related to this thesis.
