...
\begin{document}
    ...
    \lstinputlisting[language=PHP,label=docblock,caption=PHP DocBlocks]{src/php/docBlock.php}
    ...
    \\
    There is no official standard for the use of annotations, but most projects follow the phpDocumentor\footnotemark{http://www.phpdoc.org/} syntax.
    \footnotext{}
