...
\end{equation}
    ...
    \\
    The \textbf{Hindley-Milner} type system was found in 1969 by Roger J. Hinldey\cite{Hin:69} and rediscovered by Robin Milner\cite{Mil:78} in 1978.
    Damas\cite{Dam82}
    
    The first algorithm use to infer types was \texttt{algoritm W}, which was based on the  type system.
    %todo: actually explain
    This line explains what hinley milner does..
    ...
    \paragraph{Type inference algorithms}
