...
\end{equation}
    ...
    Damas proved with \textbf{Algorithm W}\cite{Dam:82} the soundness and completeness of the HM type system,  in the context of the programming language \texttt{ML}.
