...
\abstract{
Dynamic language are generally hard to statically analyse because of their run-time dependencies, which cannot be determinated without running the program.
Because dynamic languages are PHP are widely used, the need for decent analysis tool grow.
This research examines the value of adding annotations to PHP code to improve the analysability.
In the results we see that annotations improve the analysability of software code.
